...
biomass_annuals_alfalfa <- read.csv("../cap_data/cap_biomass_crops.csv", header = T)
# rename the rotation column to "Treatment"
biomass_annuals_alfalfa <- biomass_annuals_alfalfa %>% rename(Treatment = Rotation, Biomass = Biomass_kg_ha)

# Biomass - Cover crops
biomass_covercrops <- read.csv("../cap_data/cap_biomass_covercrops.csv", header = T)
biomass_covercrops <- biomass_covercrops %>% rename(treatment = Rotation, Biomass = Biomass_kg_ha)

# Biomass - non-cover crops
biomass_weeds = read.csv("../cap_data/cap_biomass_weed.csv", header = T)
biomass_weeds <- biomass_weeds %>% rename(Treatment = Rotation, Biomass = Biomass_kg_ha)
...
treatments <- distinct(biomass_annuals_alfalfa, Treatment)
