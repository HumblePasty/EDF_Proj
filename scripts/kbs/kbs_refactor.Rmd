...
biomass_annuals_alfalfa <- read.csv("../kbs_msce/kbs_mcse_biomass_annual_crops_and_alfalfa.csv", header = T, skip = 29)
...
# Biomass - Cover crops
biomass_covercrops <- read.csv("../kbs_msce/kbs_mcse_biomass_cover_crop.csv", header = T, skip = 27)
...
biomass_weeds = read.csv("../kbs_msce/40-non+crop+biomass+1715975001.csv", header = T, skip = 53)
...
biomass_compilation = read.csv("../kbs_msce/291-biomass+compilation+of+herbaceous+systems+1715975221.csv", header = T, skip = 26)
